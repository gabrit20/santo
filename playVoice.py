...
def playText(language, textID):
    ...
    try:
        ...
        if (language == 'IT'):
            ...
            saveAudio(2, 2, 7, 'D', 1, audio_text=alltext.text[textID][1], audio_filename='../audio/' + 'Language'+language+'/'+textID)
        elif (language == 'EN'):
...
def playArchive(language, textID, archive, row, column):
