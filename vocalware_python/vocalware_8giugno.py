...
def saveAudio(engine_id, language_id, voice_id, effect_type, effect_level, 
        ...
        #if (audio_text[-1] != "."):
        #        audio_text += "."
        #print("TEXT FULL STOP", audio_text)
...
##                
##                #split_audio = audio_text.split()
##                #print("split",split_audio)
##                #audio_text = ""
##                #for i in split_audio:
##                #        audio_text += i
##                #        audio_text += " "
##                #print("TEXT", audio_text)
##                
...
##        except:
##                print("TTS exception!")
##                logging.info("TTS exception!"+ audio_text)
##                audio_text = audio_text + ".Hmm"
##                #audio_text = "Hmm. " + audio_text
##                #print("TEXT", audio_text)
##                audio_url = generateURL(engine_id, language_id, voice_id, effect_type, effect_level, audio_text)
##                audio_file = requests.get(audio_url)
##
...
#				audio_text='Vieni bello', audio_filename='new_audio')
	#saveAudio(3, 1, 5, 'D', 0, "I'm sorry, I could not hear you", audio_filename='new_audio')
	saveAudio(2, 1, 5, 'D', 2, "Today, it's the sixteenth of May.", audio_filename='new_audio')
	#saveAudio(2, 1, 5, 'D', 2, "Today, it's the seventeenth of May", audio_filename='new_audio')
